...
public class ContaDigital extends ContaTransacoes implements ContaBancaria {
    ...
    public ContaDigital(int numeroDaConta, InstituicaoBancaria banco) {
        if (banco.equals(InstituicaoBancaria.NUBANK) || banco.equals(InstituicaoBancaria.ITAU)) {
            this.numeroDaConta = numeroDaConta;
            this.banco = banco;
            this.saldo = 0;
            this.tipoConta = TipoConta.CONTA_DIGITAL;
            this.informacaoConta = tipoConta.getDescricao() + " " + banco.getDescricao() + " " + numeroDaConta;
        } else {
            throw new OperacaoNegada("Conta Digital permitido apenas no Nubank e Itaú");
        }
    }
    ...
    public void sacar(Double valor) {
        saldo = super.sacar(valor, saldo, TipoConta.CONTA_DIGITAL);
    ...
    public void transferir(Double valor, ContaBancaria contaDestino) {
        saldo = super.transferir(valor, saldo, TipoConta.CONTA_DIGITAL, banco, contaDestino);
